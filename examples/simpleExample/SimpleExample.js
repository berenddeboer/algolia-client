...
var _kaashyapan$algolia_client$Algolia_Api$getSearchString = function (a) {
	...
	switch (_p0.ctor) {
		case 'Query':
			return A2(_elm_lang$core$Basics_ops['++'], 'query=', _p0._0);
		...
		case 'FacetingAfterDistinct':
			return A2(
				...
				A2(
					_elm_lang$core$Json_Encode$encode,
					0,
					_elm_lang$core$Json_Encode$bool(_p0._0)));
		...
		case 'HighlightPostTag':
			return A2(_elm_lang$core$Basics_ops['++'], 'highlightPostTag=', _p0._0);
		case 'SnippetEllipsisText':
			return A2(_elm_lang$core$Basics_ops['++'], 'snippetEllipsisText=', _p0._0);
		...
		case 'TypoTolerance':
			var _p2 = _p0._0;
			switch (_p2.ctor) {
				case 'TypoToleranceTrue':
					return 'typoTolerance=true';
				case 'TypoToleranceFalse':
					return 'typoTolerance=false';
				case 'TypoToleranceMin':
		...
		case 'IgnorePlurals':
			var _p3 = _p0._0;
			switch (_p3.ctor) {
				case 'IgnorePluralsTrue':
					return 'ignorePlural=true';
				case 'IgnorePluralsFalse':
					return 'ignorePlural=false';
				default:
					return A2(
						_elm_lang$core$Basics_ops['++'],
						'ignorePlural=',
		...
		case 'AroundRadius':
			var _p4 = _p0._0;
			if (_p4.ctor === 'AroundRadiusAll') {
				return 'aroundRadius=all';
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'aroundRadius=',
		...
		case 'QueryType':
			...
			switch (_p5.ctor) {
				case 'PrefixLast':
					return 'queryType=prefixLast';
				case 'PrefixAll':
					return 'queryType=prefixAll';
				default:
					return 'queryType=prefixNone';
			}
		case 'RemoveWordsIfNoResults':
			var _p6 = _p0._0;
			switch (_p6.ctor) {
				case 'RemoveNoneIfNoResults':
					return 'removeWordsIfNoResults=none';
				case 'LastWords':
					return 'removeWordsIfNoResults=lastWords';
				case 'FirstWords':
					return 'removeWordsIfNoResults=firstWords';
				default:
					return 'removeWordsIfNoResults=allOptional';
			}
		case 'RemoveStopWords':
			var _p7 = _p0._0;
			switch (_p7.ctor) {
				case 'RemoveStopWordsTrue':
					return 'removeStopWords=true';
				case 'RemoveStopWordsFalse':
					return 'removeStopWords=false';
				default:
					return A2(
						_elm_lang$core$Basics_ops['++'],
						'removeStopWordsList=',
		...
		default:
			var _p8 = _p0._0;
			switch (_p8.ctor) {
				case 'ExactOnSingleWordQueryAttribute':
					return 'exactOnSingleWordQuery=attribute';
				case 'ExactOnSingleWordQueryNone':
					return 'exactOnSingleWordQuery=none';
				default:
					return 'exactOnSingleWordQuert=word';
			}
	}
};
	...
	switch (_p10.ctor) {
				...
				url: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_p12.indexName,
							A2(_elm_lang$core$Basics_ops['++'], '?query=', params)))),
				body: _elm_lang$http$Http$emptyBody,
				httpMethod: 'GET'
			};
		case 'SearchMultipleIndexes':
			var _p14 = _p10._0;
			var requests = _elm_lang$core$Json_Encode$list(
				A2(
					_elm_lang$core$List$map,
					function (a) {
						return _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'indexName',
									_1: _elm_lang$core$Json_Encode$string(a.indexName)
								},
								_1: {
									ctor: '::',
									_0: {
			...
			var strategy = function () {
				var _p13 = _p14.strategy;
				if (_p13.ctor === 'NoStrategy') {
					return 'none';
				} else {
			...
			var body = _elm_lang$http$Http$jsonBody(
				_elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'requests', _1: requests},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'strategy',
								_1: _elm_lang$core$Json_Encode$string(strategy)
							},
							_1: {ctor: '[]'}
						}
					}));
			return {
				url: A2(_elm_lang$core$Basics_ops['++'], urlDsn, 'indexes/*/queries'),
				body: body,
				httpMethod: 'POST'
			};
		case 'SearchForFacetvalues':
			var _p17 = _p10._0;
			var httpMethod = 'POST';
			var query = function () {
				var _p15 = _p17.facetQuery;
				if (_p15.ctor === 'Just') {
					return {
						ctor: '::',
						_0: {
			...
			var maxHits = function () {
				var _p16 = _p17.maxFacetHits;
				if (_p16.ctor === 'Just') {
					return {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'maxFacetHits',
							_1: _elm_lang$core$Json_Encode$int(_p16._0)
						},
						_1: {ctor: '[]'}
					};
				} else {
			...
			var body = _elm_lang$http$Http$jsonBody(
				_elm_lang$core$Json_Encode$object(
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], maxHits, query))));
			var url = A2(
				_elm_lang$core$Basics_ops['++'],
				urlDsn,
				A2(
					_elm_lang$core$Basics_ops['++'],
					_p17.searchRecord.indexName,
					A2(
						_elm_lang$core$Basics_ops['++'],
						'/facets/',
						A2(_elm_lang$core$Basics_ops['++'], _p17.facetName, '/query'))));
			return {url: url, body: body, httpMethod: httpMethod};
		case 'AddAnObjectWithoutID':
			var _p18 = _p10._0;
			return {
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					urlDsn,
					A2(_elm_lang$core$Basics_ops['++'], 'indexes/', _p18.indexName)),
				body: _elm_lang$http$Http$jsonBody(_p18.value),
				httpMethod: 'POST'
			};
		case 'AddUpdateAnObjectByID':
			var _p19 = _p10._0;
			return {
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_p19.indexName,
							A2(_elm_lang$core$Basics_ops['++'], '/', 'a.objectId')))),
				body: _elm_lang$http$Http$jsonBody(_p19.value),
				httpMethod: 'PUT'
			};
		case 'DeleteAnObject':
			return {
		...
		case 'PartiallyUpdateAnObject':
			...
			var createIfNotExists = function () {
				var _p21 = _p22.createIfNotExists;
				if (_p21.ctor === 'Just') {
					return A2(
						F2(
							function (x, y) {
						...
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_elm_lang$core$Json_Encode$bool(_p21._0)));
				} else {
					return '';
				}
			}();
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'/',
								A2(_elm_lang$core$Basics_ops['++'], _p22.objectId, '/partial'))))),
				body: _elm_lang$http$Http$jsonBody(_p22.value),
				httpMethod: 'POST'
			};
		case 'RetrieveMultipleObjects':
			var _p24 = _p10._0;
			var attributes = function () {
				var _p23 = _p24.attributesToRetreive;
				if (_p23.ctor === 'Just') {
					return function (a) {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'attributesToRetrieve', _1: a},
							_1: {ctor: '[]'}
						};
					}(
						_elm_lang$core$Json_Encode$list(
			...
			var requests = _elm_lang$core$Json_Encode$object(
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'indexName',
							_1: _elm_lang$core$Json_Encode$string(_p24.indexName)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'objectId',
								_1: _elm_lang$core$Json_Encode$string(_p24.objectId)
							},
							_1: {ctor: '[]'}
						}
					},
			...
			return {
				url: A2(_elm_lang$core$Basics_ops['++'], urlDsn, 'indexes/*/objects'),
				body: body,
				httpMethod: 'POST'
			};
		case 'RetrieveAnObject':
			var _p26 = _p10._0;
			var attributes = function () {
				var _p25 = _p26.attributesToRetreive;
				if (_p25.ctor === 'Just') {
					return A2(
						F2(
							function (x, y) {
						...
						A2(
							...
							0,
							_elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p25._0))));
				} else {
					return '';
				}
			}();
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'/',
							A2(_elm_lang$core$Basics_ops['++'], 'objectId', attributes)))));
			return {url: url, body: _elm_lang$http$Http$emptyBody, httpMethod: 'GET'};
			...
			return {
				url: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'indexes/',
						A2(_elm_lang$core$Basics_ops['++'], _p10._0.indexName, '/settings'))),
				body: _elm_lang$http$Http$emptyBody,
				httpMethod: 'GET'
			};
		case 'ChangeIndexSettings':
			var _p28 = _p10._0;
			var forwardToReplicas = function () {
				var _p27 = _p28.forwardToReplicas;
				if (_p27.ctor === 'Just') {
					return A2(
						F2(
							function (x, y) {
						...
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_elm_lang$core$Json_Encode$bool(_p27._0)));
				} else {
					return '';
				}
			}();
			...
			return {
				url: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'indexes/',
						A2(_elm_lang$core$Basics_ops['++'], _p10._0.indexName, '/clear'))),
				body: _elm_lang$http$Http$emptyBody,
				httpMethod: 'GET'
			};
		case 'DeleteIndex':
			return {
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					urlDsn,
					A2(_elm_lang$core$Basics_ops['++'], 'indexes/', _p10._0.indexName)),
				body: _elm_lang$http$Http$emptyBody,
				httpMethod: 'DELETE'
			};
		case 'CopyIndex':
			...
			var operation = function () {
				var _p29 = _p30.operation;
				if (_p29.ctor === 'Move') {
					return _elm_lang$core$Json_Encode$string('move');
				} else {
					return _elm_lang$core$Json_Encode$string('copy');
				}
			}();
			var body = _elm_lang$http$Http$jsonBody(
				_elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'operation', _1: operation},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'destination',
								_1: _elm_lang$core$Json_Encode$string(_p30.destination)
							},
							_1: {ctor: '[]'}
						}
					}));
			return {
				url: A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'indexes/',
						A2(_elm_lang$core$Basics_ops['++'], _p30.indexName, '/operation'))),
				body: body,
				httpMethod: 'POST'
			};
		default:
			var attributes = function () {
				var _p31 = _p10._0.page;
				if (_p31.ctor === 'Just') {
					return A2(
						F2(
							function (x, y) {
							...
							_elm_lang$core$Json_Encode$object(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'page',
										_1: _elm_lang$core$Json_Encode$int(_p31._0)
									},
									_1: {ctor: '[]'}
								})));
				} else {
			...
			return {
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					urlDsn,
					A2(_elm_lang$core$Basics_ops['++'], 'indexes', attributes)),
				body: _elm_lang$http$Http$emptyBody,
				httpMethod: 'GET'
			};
	}
...
var _kaashyapan$algolia_client$Algolia$formatHeaders = function (config) {
	var headers = {
		...
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$http$Http$header, 'X-Algolia-API-Key', config.apiKey),
			_1: {ctor: '[]'}
		}
	};
	var extraHeaders = A2(
		...
		function (_p0) {
			var _p1 = _p0;
			return A2(_elm_lang$http$Http$header, _p1._0, _p1._1);
		},
		config.extraHeaders);
	...
	if (_p2._0.ctor === 'Ok') {
		...
		var status = function () {
			...
			switch (_p3.ctor) {
				...
				case 'Timeout':
					return 'Remote server did not respond';
				case 'NetworkError':
				...
				case 'BadStatus':
					...
					return A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], ' ', _p4.status.message));
				default:
				...
				A2(
					...
					_elm_lang$core$List$head(
						_elm_lang$core$List$reverse(
							A2(_elm_lang$core$String$split, '<em>', str)))))));
	var post = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$core$List$head(
			...
			_0: A2(
				_elm_lang$html$Html$span,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#3273DC'},
							_1: {
								ctor: '::',
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(highlight),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('box columns'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$img,
									{
										...
										_0: _elm_lang$html$Html_Attributes$src(
											A2(_elm_lang$core$Basics_ops['++'], 'https://image.tmdb.org/t/p/w154', actor.image_path)),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			default:
				...
				var algoliaResponseString = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{algoliaResponse: algoliaResponse, algoliaResponseString: algoliaResponseString}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Algolia instasearch with Elm'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('container column is-half'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Raw Json response'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
